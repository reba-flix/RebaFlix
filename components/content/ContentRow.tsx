  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <div 
          ref={rowRef}
          className="scrollbar-hide flex gap-3 overflow-x-auto pb-5 pt-1"
        >
        ...
        <button
          ...
          className={`absolute left-0 top-0 bottom-5 z-20 flex w-12 items-center justify-center bg-black/50 opacity-0 transition-opacity duration-300 hover:bg-black/70 ${
        ...
        <button
          ...
          className={`absolute right-0 top-0 bottom-5 z-20 flex w-12 items-center justify-center bg-black/50 opacity-0 transition-opacity duration-300 hover:bg-black/70 ${
            isHovered ? 'md:opacity-100' : ''
          }`}
        >
