          ...
          <div>
            ...
            <p className="mt-1 text-sm text-white/50">
              ...
              {movie.parts.length > 0 && (
                <span className="ml-2 text-white/30">({movie.parts.length} part{movie.parts.length !== 1 ? 's' : ''} total)</span>
              )}
            </p>
          </div>
        </div>
          ...
          {movie.parts.length > 0 ? (
            <div className="overflow-hidden rounded-xl border border-white/10 bg-[#1a1a1a]">
              <div className="flex items-center gap-2 border-b border-white/10 bg-white/[0.02] px-5 py-3">
                ...
                <h3 className="text-lg font-bold text-white">Movie Parts</h3>
                <span className="ml-auto text-xs text-white/30">{movie.parts.length} part{movie.parts.length !== 1 ? 's' : ''}</span>
              </div>
