...
export default function EditMovieForm({ movie }: { movie: any }) {
  ...
  const [formData, setFormData] = useState({
    ...
    description: stripTranslator(movie.description || ''),
    translator: extractTranslator(movie.description || ''),
    ...
    genreIds: movie.genres?.map((g: any) => g.genreId) || [] as string[],
  })
  ...
  return (
    <main className="min-h-screen px-4 pb-16 pt-28 md:px-8 lg:px-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="font-display text-4xl font-black md:text-5xl mb-8">Edit Movie</h1>
          ...
          <div className="rounded-md border border-white/10 bg-white/[0.03] p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-white/70 mb-1">Video File (Leave empty to keep existing)</label>
