...
export default function NewSeriesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // We use the same API endpoint that handles both movies and series based on type
  ...
  return (
    <main className="min-h-screen px-4 pb-16 pt-28 md:px-8 lg:px-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="font-display text-4xl font-black md:text-5xl mb-8">Add New TV Series</h1>
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button type="submit" disabled={loading}>
              {loading ? (
                ...
                <><UploadCloud className="mr-2 h-4 w-4" /> Create Series</>
              )}
            </Button>
          </div>
        </form>
