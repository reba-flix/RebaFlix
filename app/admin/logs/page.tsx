  ...
  return (
    <main className="px-4 pb-16 pt-8 md:px-8 lg:px-12 w-full">
      ...
      <div className="bg-[#1a1a1a] rounded-xl border border-white/10 p-12 flex flex-col items-center justify-center text-center">
        <h2 className="text-xl font-semibold text-white mb-2">System Health & Analytics</h2>
        <p className="text-white/60 max-w-md">
          This section is currently under construction. Here you will find server logs, security audits, and application analytics.
        </p>
      </div>
    </main>
  )
